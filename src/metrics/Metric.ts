...
import type { BatchObservableResult, ObservableResult } from './ObservableResult';
 ...
 * @since 1.3.0
 */
export type ObservableCounter<AttributesTypes extends MetricAttributes = MetricAttributes> =
