...
export function registerGlobal<Type extends keyof OTelGlobalAPI>(
	...
	if (!_global[GLOBAL_OPENTELEMETRY_API_KEY]) _global[GLOBAL_OPENTELEMETRY_API_KEY] = { version: VERSION };
...
export function getGlobal<Type extends keyof OTelGlobalAPI>(type: Type): OTelGlobalAPI[Type] | undefined {
